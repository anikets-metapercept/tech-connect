  ...
  return (
    <div className="max-w-screen-2xl mx-auto px-4 lg:px-10">
      <div className="w-full flex justify-center items-center flex-col gap-5 md:gap-10 py-16">
        <div className="w-[90%] bg-gradient-to-r from-[#FFAC01] to-[#5ECB38] flex justify-center items-center flex-col gap-5 sm:gap-8 lg:gap-10 leading-[150%] py-12 px-4 lg:px-20 rounded-lg">
        ...
        <div className="w-[90%] flex justify-center items-center flex-col lg:flex-row gap-5">
          <div className="flex justify-center items-center flex-col gap-5 text-white mt-5">
            <h3 className="text-2xl lg:text-4xl">ARTIFICIAL INTELLIGENCE</h3>
            <p className="text-lg text-left">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Assumenda
              sint at a similique eius obcaecati minus velit cum qui doloremque.
            </p>
          </div>
          <img src={homesection1img} alt="guest image" className="rounded-lg" />
        </div>
