...
function Footer() {
  return (
    <footer className="bg-[#051639] border-t border-t-white/70">
      <div className="max-w-screen-2xl mx-auto text-white py-5 px-4 lg:px-10 grid grid-cols-1 lg:grid-cols-[minmax(180px,auto)_1fr_1fr_minmax(180px,auto)] gap-8 sm:gap-10 md:gap-4">
